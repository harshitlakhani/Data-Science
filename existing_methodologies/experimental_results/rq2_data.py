...
if os.path.exists("./results_rq3=2.txt") is False:
    ...
    for repo in repos:
        ...
        for ver in vers:
            ...
            for bug in bugs:
                ...
                q_files = os.listdir(score_path+"query_sim\\")
                for q_type in q_files:

                    file_scores = get_file_score(score_path+"query_sim\\"+q_type, norm)
                    top_rank, rr, ap, _, _  = evaluation(file_scores, gtfs, len(file_scores), 100000) 
                    f = open("./results_rq2.txt","a", encoding="utf8")
